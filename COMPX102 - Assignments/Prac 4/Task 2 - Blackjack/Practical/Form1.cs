...
namespace Practical
{
    public partial class Form1 : Form
    {
        ...
        private Deck deck;
        private Hand playerHand;     // Hand for player
        private Hand dealerHand;     // Hand for dealer
        ...
        **/
        ...
        {
            // Deal a card to the player and dealer using the Hand objects
            playerHand.AddCard(deck.DealCard());
            dealerHand.AddCard(deck.DealCard());

            // Display hands
            playerHand.DisplayHand(listBoxPlayer);
            dealerHand.DisplayHand(listBoxDealer);
            ...
            else if (dealerHand.Total > BLACKJACK)
            {
                WinGame();
                ClearGame();
            }
            else if (playerHand.Total == BLACKJACK)
            {
                WinGame();
                ClearGame();
            }
        ...
        private void buttonReplay_Click_1(object sender, EventArgs e)
        {
            ClearGame();
        }
    }
